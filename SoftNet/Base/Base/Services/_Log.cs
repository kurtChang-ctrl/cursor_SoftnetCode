...
namespace Base.Services
{
    ...
    public static class _Log
    {
        ...
        public static async Task SocketLogAsync(string fileName, string msg)
        {
             await LogFileAsync(GetFilePath(fileName), msg);
        }
        ...
        public static async Task ErrorAsync(string msg, bool emailRoot = false)
        {
            ...
            if (emailRoot)
            {
                _Fun.Mail_Send(new string[] { _Fun.Config.AdministratorEmail }, null, $"System Error Mail MEG. from ServerId={_Fun.Config.ServerId}", msg, null, false);
            }
                //await _Email.SendRootAsync(msg);
        }
        public static void WarningMail(string MailSub, string MailBody)
        {
            _Fun.Mail_Send(new string[] { _Fun.Config.SystemEmail }, new string[] { _Fun.Config.AdministratorEmail }, MailSub, MailBody, null, false);
        }
