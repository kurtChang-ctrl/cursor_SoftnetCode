...
<div id='xgArea' class='modal fade xg-modal' data-backdrop='static' data-keyboard='false'>
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            ...
            <div class='modal-footer'>
                <button type='button' class='btn btn-secondary xg-btn-size xd-cancel' data-dismiss='modal'>{baseR.BtnCancel}</button>
...
<!-- show div -->
<div id='xgShowDiv' class='modal fade xg-modal' data-backdrop='static' data-keyboard='false'>
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            <div class='modal-header'>
                <h4 class='modal-title'></h4>
            ...
            <div class='modal-body'>
                <label id='labelxgShowDiv' value=''></label>
            </div>
        </div>
    </div>
</div>
...
<!-- show div -->
<div id='xgShowDiv' class='modal fade xg-msg'>
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            <div class='modal-header'>
                <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
    ...
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            ...
            <div class='modal-footer justify-content-between'>
                ...
                <button type='button' class='btn btn-primary xg-btn-size xd-close' data-dismiss='modal'>{baseR.BtnClose}</button>
            </div>
        </div>
    </div>
</div>
