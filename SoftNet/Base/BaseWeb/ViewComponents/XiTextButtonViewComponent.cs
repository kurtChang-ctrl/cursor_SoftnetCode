...
{
    public class XiTextButtonViewComponent : ViewComponent
    {
        public HtmlString Invoke(XiTextDto dto)
        {
            ...
            //get input html
            var html = $"<input{attr} data-type='text' class='form-control xi-box {dto.BoxClass}'><button type='button' class='btn btn-link' onclick='_me.onShowPartNO()'><i class='ico-eye' title='查閱'></i></button>";
