...
{
    public class Select2Controller : ApiCtrl
    {
        private SNWebSocketService _WebSocket = null;
        private SFC_Common _SFC_Common = null;

        public Select2Controller(SNWebSocketService websocket, SFC_Common sfc_Common)
        {
            if (_WebSocket == null)
            {
        ...
        private Select2Service EditService()
        {
            return new Select2Service(Ctrl);
        }
