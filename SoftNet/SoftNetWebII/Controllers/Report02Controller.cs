...
{
    public class Report02Controller : ApiCtrl
    {
        private SNWebSocketService _WebSocket = null;
        private SFC_Common _SFC_Common = null;
        public Report02Controller(SNWebSocketService websocket, SFC_Common sfc_Common)
        {
            if (_WebSocket == null)
            {
        ...
        private Report02Service EditService()
        {
            return new Report02Service(Ctrl);
        }
    }
}
