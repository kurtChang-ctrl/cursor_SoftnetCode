...
//small public components  處理 訊息,警示,確認畫面
var _tool = {
    ...
    */
    ...
    showDisplayDIV: function (title, value) {
        //set title
        var box = _tool.xgShowDiv;
        box.find('.modal-title').text(title);

        //get value & yes button status
        //var obj = box.find('label');
        //debugger;
        //$('#labelxgShowDiv').val(value);
        document.getElementById("labelxgShowDiv").innerHTML = value;
        //obj.val(value);
        //_itextarea.setEditO(obj, isEdit);
        //_btn.setEditO(box.find('.xd-yes'), isEdit);
