...
var _crud = {
    ...
    */
    ...
    init: function (dtConfig, edits, updName) {
        ...
        if (_me.hasEdit) {
            ...
            if (edits == null) {
                edit0 = new EditOne(this.DbKeyName); //產生kid值
                //_me.hasChild = false;
            } else {
                edit0 = (edits[0] === null) ? new EditOne(this.DbKeyName) : edits[0];
    ...
    */
    ...
    onSave: function () {
        ...
        //var isNew = edit0.isNewRow();
        var isNew = false;
        var action = this.IsCreate ? 'Create' : 'Update';
        if (action == 'Create') { isNew = true; }
        this.IsCreate = false;
        ...
        if (_crud.hasFile()) {
            ...
            if (!isNew) {
                var ff = this.DbKeyNameS;
                if (this.DbKeyNameS != null) {
                    data.key = edit0.getKey(this.DbKeyNameS);
                }
                else {
