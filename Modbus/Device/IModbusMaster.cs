...
namespace Modbus.Device
{
	...
	public interface IModbusMaster : IDisposable
	{
		...
		bool WriteSingleCoil(byte slaveAddress, ushort coilAddress, bool value);
		...
		/// <param name="value">Value to write.</param>
        bool WriteSingleRegister(byte slaveAddress, ushort registerAddress, ushort value);
        ...
        bool WriteMultipleRegisters(byte slaveAddress, ushort startAddress, ushort[] data);
		...
		/// <param name="startAddress">Address to begin writing values.</param>
		/// <param name="data">Values to write.</param>
        bool WriteMultipleCoils(byte slaveAddress, ushort startAddress, bool[] data);
