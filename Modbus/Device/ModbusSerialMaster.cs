...
namespace Modbus.Device
{
	...
	public class ModbusSerialMaster : ModbusMaster, IModbusSerialMaster
	{
        ...
        /// <summary>
        /// get Modbus SerialPort Is Work.
        /// </summary>
        public bool IsSerialPortWork
        {
            get
            {
                bool re = false;
                if (sP != null && sP.IsOpen) { re = true; }
                return re;
            }
        }
		/// <summary>
		...
		public bool ReturnQueryData(byte slaveAddress, ushort data)
		{
            ...
            string err = "";
			DiagnosticsRequestResponse response = Transport.UnicastMessage<DiagnosticsRequestResponse>(request,ref err);
            //###???
