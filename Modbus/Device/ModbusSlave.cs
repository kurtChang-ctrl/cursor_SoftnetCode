...
namespace Modbus.Device
{
	...
	{
        /// <summary>
        /// EventModbusSlaveProtoclLOG Event.
        /// </summary>
        public delegate void EventModbusSlaveProtoclLOG(IModbusMessage receiveData, IModbusMessage responseData);
        /// <summary>
        /// EventModbusSlaveProtoclLOG Event.
        /// </summary>
        public event EventModbusSlaveProtoclLOG ModbusSlaveProtoclLOG;//從外部來的訊號 例:proxyserver

        /// <summary>
        /// ERROR Event.
        /// </summary>
        public delegate void ERROR(uint ErrorCode, string MEG);
        /// <summary>
        /// ERROR Event.
        /// </summary>
        ...
        /// <summary>
        /// Modbus slave object isWork
        /// </summary>
        public delegate bool ModbusSlaveIsWork();
        /// <summary>
        /// Modbus slave object isWork
        /// </summary>
        public event ModbusSlaveIsWork isWork;
        ...
        /// Traget Error.
        /// </summary>
        public void TragetError(uint ErrorCode, string MEG)
        {
            if (Error != null) { Error(0x44002, "Modbus error: " + MEG); }
        }
        /// <summary>
        /// Modbus Slave isWork state.
        /// </summary>
        public bool IsWork()
        {
            if (isWork != null) return isWork();
            return false;
        }
		/// <summary>
        ...
        /// <summary>
        /// Stop slave listening for requests.
        /// </summary>
		...
		{
            if (EnableModeBusLog && ModbusSlaveProtoclLOG != null)
            {
                ModbusSlaveProtoclLOG(request, null);
            }
			//_logger.Info(request.ToString());
            if (LogUtility.IsEnable) LogUtility.Debug(request.ToString(), "ApplyRequest");
			...
			switch (request.FunctionCode)
			{
				...
				default:
                    ...
                    if (LogUtility.IsEnable) LogUtility.Debug(errorMessage, "ApplyRequest");
					throw new ArgumentException(errorMessage, "request");
			}
            if (EnableModeBusLog && ModbusSlaveProtoclLOG != null) 
            {
                ModbusSlaveProtoclLOG(request, response);
            }
			return response;
		}
	}
